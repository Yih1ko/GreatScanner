...
static constexpr auto qt_meta_stringdata_CLASSLayerManagerENDCLASS = QtMocHelpers::stringData(
    "LayerManager"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSLayerManagerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSLayerManagerENDCLASS_t qt_meta_stringdata_CLASSLayerManagerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12)   // "LayerManager"
    },
    "LayerManager"
};
